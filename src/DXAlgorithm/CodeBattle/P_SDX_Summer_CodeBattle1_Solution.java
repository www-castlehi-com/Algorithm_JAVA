...
class P_SDX_Summer_CodeBattle1_Solution
{
    ...
    private final static P_SDX_Summer_CodeBattle1_UserSolution usersolution = new P_SDX_Summer_CodeBattle1_UserSolution();
