...
public class P_SDX_Summer_4_No1 {
    ...
    static private class UserSolution {
        ...
        public int dfs(int N) {
            ...
            while (top != -1) {
                ...
                for (int i = 0; i < 5; i++) {
                    if (graph[peek][i] != 0 && !visited[graph[peek][i]]) {
                        stack[++top] = graph[peek][i];
                        visited[graph[peek][i]] = true;
                        canVisit = true;
                        break;
                    }
                }
                if (!canVisit) stack[top--] = 0;
            }
    ...
    public static UserSolution usersolution = new UserSolution();
